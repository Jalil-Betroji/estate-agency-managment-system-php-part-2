...
if(isset($_SESSION['email'])){
    ...
    $selectUserAnnounce = "SELECT announces.Announce_ID,Client_ID,Title,Area,Rooms,Bathrooms,Price,
...
if(isset($_POST['searchbtn'])){
  ...
  Image_Path
  FROM announces INNER JOIN images ON announces.Announce_ID = images.Announce_ID WHERE Image_Type = 1";       
if (!empty($min_Price)) {            
